...
defs = Definitions(
    assets=[dbt_project_assets, mysql_raw_load],
    jobs=[daily_full_pipeline_job, daily_mysql_ingest_job, daily_dbt_job],
    schedules=[daily_mysql_3am_schedule, daily_dbt_4am_schedule],
    resources={
